...
public class Problema_5_2 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnListar(ActionEvent arg0) {
		txtS.setText("");
		for(int e=0; e<as.tamanio(); e++) {
			imprimir("n[" + e + "] :  " + as.obtener(e));
		}
	}
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("cantidad Mayores Sueldo Promedio: " + as.cantMayoresSueldoPromedio());
		imprimir("cantidad Menores Sueldo Promedio: " + as.cantMenoresSueldoPromedio());
		imprimir(" posSegundoSueldoMayorAlMinimo: " + as.posSegundoSueldoMayorAlMinimo());
		imprimir("posUltimoSueldoMenorAlMinimo: " + as.posUltimoSueldoMenorAlMinimo());
	}
